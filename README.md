...
| Central KVIC Circulars | 110 | Pending Audit | 94 | 🟡 In Progress | `[████████░░]` (85.5%) |
...
| [docs/ADMINISTRATIVE_HIERARCHY.md](docs/ADMINISTRATIVE_HIERARCHY.md) | The three-layer PMEGP administrative hierarchy in AP (Commissioner / Collector / PD-GM) — definitive operational baseline for district-level targeting. |
